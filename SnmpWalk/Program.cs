    ...
    class Program
    {
        static void Main(string[] args)
        {
            Dictionary<String, Dictionary<uint, AsnType>> result =
                new Dictionary<String, Dictionary<uint, AsnType>>();

            // Not every row has a value for every column so keep track 
            //of all columns available in the table
